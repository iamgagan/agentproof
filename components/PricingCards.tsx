        ...
        <StaggerItem>
          ...
          >
            ...
            <div style={{ marginBottom: '24px' }}>
              <span style={{ fontFamily: 'var(--font-mono)', fontSize: '40px', fontWeight: 700, color: 'var(--text-primary)' }}>$0</span>
              <span style={{ color: 'var(--text-muted)', fontSize: '14px', marginLeft: '6px' }}> / forever</span>
            </div>
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, flex: 1 }}>
              {FREE_FEATURES.map((f) => (
                <li key={f} style={{
                  ...
                  <Check size={14} style={{ color: 'var(--text-muted)', flexShrink: 0 }} /> {f}
                </li>
              ))}
            </ul>
        ...
        <StaggerItem>
          ...
          >
            ...
            <div style={{ marginBottom: '8px' }}>
              <span style={{ fontFamily: 'var(--font-mono)', fontSize: '40px', fontWeight: 700, color: 'var(--text-primary)' }}>$199</span>
              <span style={{ color: 'var(--text-muted)', fontSize: '14px', marginLeft: '6px' }}> one-time</span>
            </div>
            ...
            <div style={{ marginTop: '28px' }}>
              {proPriceId ? (
                ...
                <p style={{ textAlign: 'center', color: 'var(--text-muted)', fontSize: '13px', fontFamily: 'var(--font-body)' }}>
