  ...
  return (
    <>
      <style>{`
        ...
        .hero-nav-mobile-menu { display: block; }
        @media (min-width: 768px) {
          .hero-nav-desktop { display: flex; }
          .hero-nav-hamburger { display: none !important; }
          .hero-nav-mobile-menu { display: none !important; }
        }
      `}</style>
      <nav style={{ position: 'relative', zIndex: 30 }}>
        <div style={{
          maxWidth: '1280px',
          margin: '0 auto',
          display: 'flex',
          ...
          <div className="hero-nav-desktop" style={{ alignItems: 'center', gap: '32px' }}>
            {navLinks.map((link) => (
              <Link
                key={link.label}
                href={link.href}
          ...
          {/* Desktop auth — right */}
          <div className="hero-nav-desktop" style={{ alignItems: 'center', gap: '12px' }}>
            {isSignedIn ? (
        ...
        <AnimatePresence>
          {mobileOpen && (
            <motion.div
              key="mobile-menu"
              className="hero-nav-mobile-menu"
