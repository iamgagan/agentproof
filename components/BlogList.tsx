...
export default function BlogList({ posts }: { posts: BlogPost[] }) {
  return (
    <>
      <Navbar />
      <main style={{ maxWidth: '900px', margin: '0 auto', padding: '60px 24px 80px', flex: 1 }}>
        <FadeInUp>
          <p
            style={{
              ...
              >
                <motion.article
                  whileHover={{
                    ...
                    boxShadow: '0 0 40px rgba(0, 229, 204, 0.04)',
                    y: -2,
                  }}
                ...
                >
                  ...
                  >
                    ...
                    <span style={{ fontSize: '13px', color: 'var(--accent-teal)', fontFamily: 'var(--font-body)', fontWeight: 500 }}>
                      Read article &rarr;
                    </span>
                  </div>
                </motion.article>
